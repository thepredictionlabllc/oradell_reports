...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20220414/Fig_chla_week.pdf){:             width="600px"}{: .align-center}
<br clear="all" />
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20220414/Fig_cyan.pdf){: width="600px"}{: .align-center}
<br clear="all" />
